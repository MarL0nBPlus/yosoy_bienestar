        ...
        <section className="sm:px-0 md:px-0 lg:px-0 px-4 pt-6 pb-32 bg-[#F2F2F2]">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    {planes.map((item, idx) => (
                        <SwiperSlide key={idx}>
                            <div className={`${item.destacado ? "bg-[#FF5F00] shadow-2xl" : "bg-[#B85564]"} rounded-[20px] p-1 relative`}>
                                {
                                    item.destacado ?
                                ...
                                <div className='bg-white h-auto sm:h-[400px] md:h-[400px] lg:h-[400px] rounded-b-[15px] flex flex-col p-8'>
                                    ...
                                    <h2 className='text-[30px] sm:text-[70px] md:text-[70px] lg:text-[70px] text-[#9F2241] font-bold mx-auto'><span className='text-[12px] sm:text-[20px] md:text-[20px] lg:text-[20px] sm:text-[60px] md:text-[60px] lg:text-[60px]'>$</span>{item.costo}.<sup>00</sup> </h2>
