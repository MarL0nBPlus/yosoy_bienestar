      ...
      <div className="w-full sm:w-7xl md:w-7xl lg:w-7xl mx-auto flex gap-12 items-start relative z-20 px-12 sm:px-0 md:px-0 lg:px-0">
        <div className="flex flex-col gap-4">
          ...
          <a
            ...
            href={junBtnUrl}
          >
            <span className="absolute w-120 h-0 transition-all duration-300 origin-center rotate-0 -translate-x-20 bg-black top-1/2 group-hover:h-64 group-hover:-translate-y-32 ease"></span>
