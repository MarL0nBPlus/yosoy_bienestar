...
const PlanesConserva = () => {
    return (
        <section className="sm:px-0 md:px-0 lg:px-0 px-4 pt-6 bg-[#F2F2F2]">
            <h2 className="text-[50px] text-[#9B264A] text-center">1. Selecciona un paquete</h2>
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    {planes.map((item, idx) => (
                        <SwiperSlide key={idx}>
                            <div className={`${item.destacado ? "bg-[#FF5F00] shadow-2xl" : "bg-[#E3D3BD] hover:bg-[#B85564] transition-all"} group rounded-[20px] p-1 relative`}>
                                {
                                    item.destacado ?
                                ...
                                <h3 className={`text-center ${item.destacado ? "group-hover:text-white text-[#9F2241]  text-[16px] sm:text-[29px] md:text-[29px] lg:text-[29px] py-3" : "group-hover:text-white text-[#9F2241] text-[14px] sm:text-[22px] md:text-[22px] lg:text-[22px] py-4"}`}>{item.titulo}</h3>
                                <div className='bg-white h-auto sm:h-[400px] md:h-[400px] lg:h-[400px] rounded-b-[15px] flex flex-col p-8'>
                                    ...
                                    <h2 className='text-[30px] sm:text-[70px] md:text-[70px] lg:text-[70px] text-[#9F2241] font-bold mx-auto'><span className='text-[12px] sm:text-[60px] md:text-[60px] lg:text-[60px]'>$</span>{item.costo}.<sup>00</sup> </h2>
                                    {
                                        item.destacado ?
                                            <a
                                            ...
                                            :
                                            <a
                                                className="text-[#9B264A] border text-center border-[#9B264A] hover:text-black rounded-[50px] py-2 px-2 sm:px-12 md:px-12 lg:px-12 flex items-center w-fit overflow-hidden uppercase text-[17px] relative group cursor-pointer mx-auto mt-6"
                                                href="/product_page/paquetegb"
                                            >
